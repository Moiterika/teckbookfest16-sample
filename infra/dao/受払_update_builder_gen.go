...
func (ub *ub受払) Set(field fld受払, val interface{}) *ub受払 {
	k := string(field)
...
func (ub *ub受払) Count() int {
	return len(ub.config)
}
func (ub *ub受払) build(wb Wb受払) (s string, w string, execArgs []interface{}) {
	if ub.Count() == 0 {
		// 更新項目なし
		return
	}
...
func (ub *ub受払) copyMap() map[string]interface{} {
