...
func (ub *ubログ) Set(field fldログ, val interface{}) *ubログ {
	k := string(field)
...
func (ub *ubログ) Count() int {
	return len(ub.config)
}
func (ub *ubログ) build(wb Wbログ) (s string, w string, execArgs []interface{}) {
	if ub.Count() == 0 {
		// 更新項目なし
		return
	}
...
func (ub *ubログ) copyMap() map[string]interface{} {
