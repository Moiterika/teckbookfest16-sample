...
func (r *repDb品目) list() (list []*objects.Ent品目, err error) {
	dt品目, errDt := r.rm.dm.NewDaoDb品目().Dt()
	if errDt != nil {
...
func (r *repDb品目) List() ([]*objects.Ent品目, error) {
...
func (r *repDb品目) getBy(id dao.Id) (e *objects.Ent品目, err error) {
...
func (r *repDb品目) AddNew(e *objects.Ent品目) error {
